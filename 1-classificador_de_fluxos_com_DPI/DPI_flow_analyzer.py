...
class ProcessadorDPI:
    def __init__(self, applications):
        ...
        self.dir_dpi_txt = Path('1-classificador_de_fluxos_com_DPI/dpi_txt')
        self.dir_flows = Path('1-classificador_de_fluxos_com_DPI/flows')
        self.dir_criterios = Path('1-classificador_de_fluxos_com_DPI/porta_ip')
        self.dir_output = Path('1-classificador_de_fluxos_com_DPI/flows_filtrados')
